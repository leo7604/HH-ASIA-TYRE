# HH ASIA TYRE - Quick Slide Content (Customer-Facing Only)
## Copy-Paste Ready for PowerPoint - NO ADMIN FEATURES
...
Team: Leonardo Reparejo Jr., Asher Dane Manzano, 
      Eric Godwin Jose, Felix Gallardo
...
Scope: 6 branches | 6+ services | Customer portal | ~8,000+ lines
```
...
3. Services grid
4. Branch locations (Manila)
5. Branch locations (Laoag)
...
**NO ADMIN FEATURES - Customer-focused only!** ✨
