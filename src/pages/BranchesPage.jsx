...
function BranchesPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Manila Branches */}
      <div className="py-16 px-6 bg-gradient-to-b from-brand-black to-brand-card">
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-4 h-4 bg-brand-yellow rounded-full mx-auto animate-pulse shadow-[0_0_16px_rgba(255,215,0,0.5)]" />
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5">
                  ...
                  <div className="space-y-2 mb-4">
                    {location.phone && (
                      <a href={`tel:${location.phone}`} className="flex items-center gap-2 text-brand-textMuted text-sm hover:text-brand-yellow transition-colors">
                    ...
                    {location.mobile && (
                      <a href={`tel:${location.mobile}`} className="flex items-center gap-2 text-brand-textMuted text-sm hover:text-brand-yellow transition-colors">
                        <svg className="w-4 h-4 text-brand-yellow flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {location.services.slice(0, 4).map((service, idx) => (
                      <span
                        key={idx}
                        className="text-[0.7rem] font-medium px-2.5 py-1 rounded bg-brand-raised border border-brand-border text-brand-textMuted"
                      >
                        {service}
                      </span>
                    ))}
          ...
          <div className="relative bg-gradient-to-br from-brand-yellow/15 via-brand-yellow/8 to-brand-yellow/5 border border-brand-yellow/30 rounded-2xl p-10 md:p-12 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-brand-textMuted text-base mb-6 max-w-xl mx-auto">
                ...
                Our mobile service units can come to you.
              </p>
